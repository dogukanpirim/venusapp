...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function createFBO(w: number, h: number, internalFormat: any, format: any, type: any, param: any): any {
    ...
    function createDoubleFBO(w: number, h: number, internalFormat: any, format: any, type: any, param: any): any {
    ...
    function resizeFBO(target: any, w: number, h: number, internalFormat: any, format: any, type: any, param: any): any {
    ...
    function resizeDoubleFBO(target: any, w: number, h: number, internalFormat: any, format: any, type: any, param: any): any {
    ...
    function splat(x: any, y: any, dx: any, dy: any, color: any) {
      ...
      (gl as any).uniform1f(
        ...
        (canvas as any).width / (canvas as any).height
      );
    ...
    function correctRadius(radius: any): any {
      let aspectRatio = (canvas as any).width / (canvas as any).height;
